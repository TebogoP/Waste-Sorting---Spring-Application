...
@SpringBootTest
class WasteCateReposTest {
    @Autowired
    private WasteCatRepository repository;
    ...
    void findById_ShouldReturnCategory_WhenExists() {
        ...
        // Test
        WasteCategory found = repository.findById(1).orElse(null);
    ...
    void saveAll_ShouldAddMultipleCategories() {
        ...
        // Assert
        List<WasteCategory> found = repository.findAll();
    ...
    void setUp() {
        ...
        List<WasteCategory> existingCategories = repository.findAll();
